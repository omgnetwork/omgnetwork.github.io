...
There are several versions of Plasma, including MoreVP, OmiseGO's chosen solution. 
Different versions of Plasma are suited to specific use cases and the operator (OmiseGO in this case) typically chooses the most suitable version for their scenario. From the users’ perspective, all versions of Plasma behave more or less the same.
