...
It is important to follow a naming convention for functions. This allows developers to start working with eWalletDB quickly, easily and without ambiguity,
This guide describes the conventions used throughout this `eWalletDB` project.
