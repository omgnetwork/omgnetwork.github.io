  ...
  return (
    <>
      ...
      <script
        type='text/javascript'
        dangerouslySetInnerHTML={{__html:`
          (function(){var w=window;var ic=w.Intercom;if(typeof ic==="function"){ic('reattach_activator');ic('update',w.intercomSettings);}else{var d=document;var i=function(){i.c(arguments);};i.q=[];i.c=function(args){i.q.push(args);};w.Intercom=i;var l=function(){var s=d.createElement('script');s.type='text/javascript';s.async=true;s.src='https://widget.intercom.io/widget/r0u30zii';var x=d.getElementsByTagName('script')[0];x.parentNode.insertBefore(s,x);};if(w.attachEvent){w.attachEvent('onload',l);}else{w.addEventListener('load',l,false);}}})();
        `}}
      />
        ...
        <div className='footer-wrapper'>
          <div className='footer-column'>
            ...
            <span className='footer-item'>
              <a target='_blank' href='https://github.com/omisego/dev-portal/blob/master/guides/morevp_eli5.md'>
                {`Learn MoreVP\nArchitecture`}
              </a>
            </span>
            <span className='footer-item'>
              <a target='_blank' href='https://github.com/omisego/dev-portal/blob/master/guides/plasma_interface_from_browser.md'>
          ...
          <div className='footer-column'>
            ...
            <span className='footer-item'>
              <a target='_blank' href='https://github.com/omisego/omg-js/blob/master/README.md'>
                {`omg-js`}
              </a>
            </span>
          </div>
